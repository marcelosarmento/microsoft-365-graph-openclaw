# Mail Webhook Setup and Operations Runbook

Use this runbook only when explicitly asked for mail push setup, webhook infrastructure, EC2/Caddy/systemd work, privileged automation, smoke tests, or full pipeline troubleshooting. Daily mail/calendar/drive/contact work should stay in `SKILL.md` and `references/`.
